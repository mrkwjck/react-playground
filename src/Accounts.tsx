                    ...
                    : data.map((account: Account) => (
                          <li key={account.accountNumber}>
                              ...
                              <span className="column actions">
                                  <button
                                      onClick={() =>
                                          changeViewModeHandler(ViewMode.DEPOSIT_FORM, account.accountNumber)
                                      }>
                                      Wpłać
                                  </button>
                                  <button
                                      onClick={() =>
                                          changeViewModeHandler(ViewMode.WITHDRAWAL_FORM, account.accountNumber)
                                      }>
                                      Wypłać
                                  </button>
                                  <button
                                      onClick={() =>
                                          changeViewModeHandler(ViewMode.TRANSACTIONS, account.accountNumber)
                                      }>
                                      Historia transakcji
                                  </button>
                              </span>
